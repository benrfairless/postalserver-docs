...
### General features:
 ...
 - Set up webhooks to receive live information about delivery information in realtime. Webhook requests are cryptographically signed, and the last 10 days of webhook requests are stored for debugging purposes.
 ...
 - Prometheus metrics and health check endpoints for the worker and SMTP server processes.
 - Optional single sign-on using any OpenID Connect identity provider.
 - Configure entirely through a YAML file, environment variables, or both.
### Outgoing e-mails:
 ...
 - Enable development mode to hold messages in Postal without actually delivering them to recipients (messages can be viewed in the Postal interface).
 ...
 - Optionally relay all outgoing mail through one or more smart hosts.
...
### Incoming e-mails:
 ...
 - Spam & threat checking with SpamAssassin or rspamd and ClamAV with configurable thresholds and different methods for dealing with spam messages.
